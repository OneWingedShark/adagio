...
------------------------------------------------------------------------------
--  $Id: adagio-http-header-response.ads,v 1.3 2004/01/21 21:05:37 Jano Exp $

package Adagio.Http.Header.Response is

   ------------------------------------------------------------------------
   -- Create_response                                                    --
   ------------------------------------------------------------------------
   -- Create the response for a file request, being it partial or not
   -- Adds necessary headers in Result
   -- RSize is the size of the requested object
