...
------------------------------------------------------------------------------
--  $Id: adagio-upload-resource-factory.ads,v 1.4 2004/01/29 21:47:10 Jano Exp $

-- Obtaining resources from a request string.

package Adagio.Upload.Resource.Factory is
   ...
   function Create (Request : in String) return Resource.Object_access;
