...
package Adagio.Library.Query is
   ...
   -- The Words string will be normalized stripping everything except
   --   numbers and characters. Equivalences to basic char will be per-
   --   formed. Words can hence be separated by any non character/number.
   -- Words can be separated by an arbitrary number of separators.
