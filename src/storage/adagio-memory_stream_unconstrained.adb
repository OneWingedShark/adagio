...
------------------------------------------------------------------------------
--  $Id: adagio-memory_stream_unconstrained.adb,v 1.3 2004/01/21 21:05:41 Jano Exp $

--  Allows reading from a string viewed as an stream:

package body Adagio.Memory_stream_unconstrained is
...
end Adagio.Memory_stream_unconstrained;
=======
------------------------------------------------------------------------------
--                         ADAGIO - ADALID - AENEA.                         --
--                                                                          --
