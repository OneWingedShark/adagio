...
with Charles.Multisets.Sorted.Unbounded;
...
package Protected_sorted_index is

   pragma Preelaborate;

   package Implementation is new Charles.Multisets.Sorted.Unbounded (
      Element_type, "<", "=");
   ...
   private
      ...
      List : Implementation.Container_type;
