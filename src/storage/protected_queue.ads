...
------------------------------------------------------------------------------
--  $Id: protected_queue.ads,v 1.3 2004/01/21 21:05:44 Jano Exp $

with Charles.Lists.Double.Unbounded;

generic
   type Item_type is private;
   with function "=" (L, R : Item_type) return Boolean;
package Protected_queue is

   pragma Preelaborate;

   package Queue is new Charles.Lists.Double.Unbounded (Item_type, "=");
