...
------------------------------------------------------------------------------
--  $Id: adagio-filter_stream.adb,v 1.3 2004/01/21 21:05:41 Jano Exp $
...
package body Adagio.Filter_stream is
   ...
   begin
      Read (Stream.Chained.all, Item, Last);
   end Read;
