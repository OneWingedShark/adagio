...
generic
   ...
   with function "+"(Left, Right: Item) return Item;
   with function "/"(Left: Item; Right: Integer) return float;
package Average_queue is
   ...
   -- May raise No_data
   function Average(this: in Object) return float;
