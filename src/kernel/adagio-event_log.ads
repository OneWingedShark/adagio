...
------------------------------------------------------------------------------
--  $Id: adagio-event_log.ads,v 1.3 2004/02/24 15:26:13 Jano Exp $
...
package Adagio.Event_log is

   pragma Elaborate_Body;

   -- Max stored traffic
   Max_traffic : Positive := 999;

   type Levels is (Debug, Normal, Warning, Error);
