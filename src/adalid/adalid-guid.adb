...
------------------------------------------------------------------------------
--  $Id: adalid-guid.adb,v 1.4 2004/01/21 21:05:24 Jano Exp $
...
package body Adalid.GUID is

   package Misc    renames Adagio.Misc;
   package Monitor renames Adagio.Monitor;

   ------------------------------------------------------------------------
   -- To_char_array                                                      --
   ------------------------------------------------------------------------
   -- Return it as a series of 16 chars.
   function To_char_array (This : Adalid.GUID.GUID) return String is
   begin
      return String (This);
   end To_char_array;
   ...
   procedure Init is
      ...
      S    : String (1 .. 100);
      Last : Integer;
      File : Constant String := "adalid.guid";
   begin
      -- Check existence:
   ...
   function To_hex (this : Adalid.GUID.GUID) return String is
   ...
   function To_string (this : in Adalid.GUID.GUID) return String is
   ...
   function To_GUID (this : in String) return Adalid.GUID.GUID is
   ...
   function Create_GUID return Adalid.GUID.GUID is
      Result : Adalid.GUID.GUID;
