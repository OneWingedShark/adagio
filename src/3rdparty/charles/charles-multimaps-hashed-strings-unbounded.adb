...
package body Charles.Multimaps.Hashed.Strings.Unbounded is
...
--   end;
   ...
   procedure Insert_Sans_Resize
     (Container : in out Container_Type;
      ...
      Iterator : Iterator_Type;
   begin
      Insert_Sans_Resize (Container, Key, New_Item, Iterator);
   end;
...
--   begin
--      Last := Target'First + To_Access (Source.I).Key_Size - 1;
--      Target (Target'First .. Last) := To_Access (Source.I).Key.Value;
--   end;
--   
