...
--                                                                          --
--              Charles.Algorithms.Generic_Compare (spec)                   --
--                                                                          --
--                                                                          --
...
generic
   ...
   with function Is_Equal (L, R : Iterator_Type) return Boolean is <>;
   
   with function "=" (L, R : Iterator_Type) return Boolean is <>;

function Charles.Algorithms.Generic_Compare
  (Left_First, Left_Back : Iterator_Type;
   Right_First           : Iterator_Type) return Boolean;
   
pragma Pure (Charles.Algorithms.Generic_Compare);
