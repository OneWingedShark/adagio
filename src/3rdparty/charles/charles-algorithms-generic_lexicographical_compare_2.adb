...
--                                                                          --
--         Charles.Algorithms.Generic_Lexigographical_Compare_2 (body)      --
--                                                                          --
--                                                                          --
...
function Charles.Algorithms.Generic_Lexicographical_Compare_2
  (Left_First, Left_Back   : Left_Type;
   ...
   LI : Left_Type := Left_First;
   RI : Right_Type := Right_First;
...
end Charles.Algorithms.Generic_Lexicographical_Compare_2;
