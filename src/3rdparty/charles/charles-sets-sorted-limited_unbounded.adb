...
package body Charles.Sets.Sorted.Limited_Unbounded is
   ...
   function Generic_Equal (Left, Right : Container_Type) return Boolean is
      ...
      function "=" is new Trees.Generic_Equal ("=");
   begin
...
--   end;
   ...
   package Keys is new Trees.Generic_Keys (Key_Type, Is_Less, Is_Less);
   use Keys;
...
end Charles.Sets.Sorted.Limited_Unbounded;
=======
pragma License (Modified_GPL);
