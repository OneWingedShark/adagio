...
--                                                                          --
--         Charles.Algorithms.Generic_Lexigographical_Compare_2 (spec)      --
--                                                                          --
--                                                                          --
...
generic
   ...
   with function "=" (L, R : Left_Type) 
      return Boolean is <>;
      
   with function "=" (L, R : Right_Type)
      return Boolean is <>;

function Charles.Algorithms.Generic_Lexicographical_Compare_2
  (Left_First, Left_Back   : Left_Type;
   Right_First, Right_Back : Right_Type) return Boolean;

pragma Pure (Charles.Algorithms.Generic_Lexicographical_Compare_2);
=======
------------------------------------------------------------------------------
--                                                                          --
--                        CHARLES CONTAINER LIBRARY                         --
