...
package body Charles.Sets.Hashed.Unbounded is
   ...
   begin
      return Is_Equal_Key (N.Element, E);
   end;


   package Element_Keys is
      new Hash_Table_Types.Generic_Keys (Element_Type, Hash, Is_Equal_Key);
   ...
   begin
      ...
      Node := new Node_Type'(Succ => Before,
                             Pred => Pred (Before),
                             Element => Element);      
   ...
   procedure Insert
     (Container : in out Container_Type;
      ...
      HT : Hash_Table_Type renames Container.Hash_Table;
   begin
      Resize (HT, Length (Container) + 1);
      Conditional_Insert_Sans_Resize (HT, New_Item, Iterator.Node, Success);
   end;
...
--      Success : Boolean;
--   begin
--      Insert_Sans_Resize (Container, Position, New_Item, Iterator, Success);
--   end;
...
--   end;
   ...
   function Lower_Bound
     (Container : Container_Type;
      Item      : Element_Type) return Iterator_Type is
   begin
      return (Node => Lower_Bound (Container.Hash_Table, Item));
   end;
   ...
   function Upper_Bound
     (Container : Container_Type;
      Item      : Element_Type) return Iterator_Type is
   begin
      return (Node => Upper_Bound (Container.Hash_Table, Item));
   end;
   ...
   begin
      Equal_Range (Container.Hash_Table, Item, First.Node, Back.Node);
   end;
   ...
   package body Generic_Keys is
      ...
      function Is_Equal_Key
        (N : Node_Access;
         ...
         pragma Inline (Is_Equal_Key);
      begin
         return Is_Equal_Key (N.Element, K);
      end;
      ...
      package body Generic_Insertion is
         ...
         package Key_Insertion is new Keys.Generic_Insertion (Insert);
         use Key_Insertion;
         ...
         begin
            Resize (HT, Length (Container) + 1);         
            Conditional_Insert_Sans_Resize (HT, Key, Iterator.Node, Success);
         end;
   ...
   begin
      return Count (Container.Hash_Table, Item);
   end;
   ...
   procedure Delete
     (Container : in out Container_Type;
      ...
      Count     :    out Natural) is
   begin
      Delete (Container.Hash_Table, Item, Count);
   end;
...
--   procedure Generic_Dump (Container : in Container_Type) is
--   
--      procedure List_Item (Node : access Node_Type) is
--      begin
--         List_Item (Node.Item);
--      end;

--      procedure Dump is new Hash_Tables.Generic_Dump;
--   begin
--      Dump (Container.Buckets.all);
--   end;
   ...
   procedure Hash_Range
     (Container   : in     Container_Type;
      ...
      First, Back :    out Iterator_Type) is
   begin
      Hash_Range (Container.Hash_Table, Index, First.Node, Back.Node);
   end;
