...
package body Charles.Sets.Hashed.Limited_Unbounded is
...
--   procedure Insert
--     (List     : in out Element_Lists.Container_Type;
--      Before   : in     Element_Lists.Iterator_Type;
--      Key      : in     Key_Type;
--      Iterator :    out Element_Lists.Iterator_Type) is
--   begin
--      Insert (List, Before, Iterator);
--      --Set_Key (To_Access (Iterator).all, Key);
--   end;
...
--   begin
--      Conditional_Insert (Container.Hash_Table, Key, Iterator.I, Success);
--   end;
