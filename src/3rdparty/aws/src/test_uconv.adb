...
--  $Id: test_uconv.adb,v 1.1 2003/10/05 20:00:06 Jano Exp $
...
procedure Test_UConv is
   ...
   Sample : constant String :=
      "$Author: Jano $" & ASCII.LF &
      "$Date: 2003/10/05 20:00:06 $" & ASCII.LF &
      "$Name:  $" & ASCII.LF &
      "$Locker:  $" & ASCII.LF &
      "$RCSfile: test_uconv.adb,v $" & ASCII.LF &
      "$Revision: 1.1 $" & ASCII.LF &
      "$Source: C:\\Documents\040and\040Settings\\Jano\\Mis\040documentos\\CD\\cvs/adagio/aws/src/test_uconv.adb,v $" & ASCII.LF &
      "$State: Exp $" & ASCII.LF;
