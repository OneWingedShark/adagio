...
procedure PragmARC.Sort_Quick_In_Place (Set : in out Sort_Set) is
   ...
   procedure Insertion_Sort (Set : in out Sort_Set) is
      Temp : Element;
      J    : Index;
   begin -- Insertion_Sort
      Search : for I in Index'Succ (Set'First) .. Set'Last loop -- Invariant: Set (Set'First .. Index'Pred (I) ) is sorted
         ...
         Insert : loop
            exit Insert when J <= Set'First or else not (Temp < Set (Index'Pred (J) ) );
