...
package PragmARC.Wrapping is
   ...
   function Wrap_Pred (Value : Item) return Item;
   -- If Value = Item'First, returns Item'Last; returns Item'Pred (Value) otherwise

   function Wrap_Succ (Value : Item) return Item;
   -- If Value = Item'Last, returns Item'First; returns Item'Succ (Value) otherwise
