...
package Aenea.Hub.Actions is

   ------------------------------------------------------------------------
   -- Ask                                                                --
   ------------------------------------------------------------------------
   -- Chooses either to make a PI or CRAWLA
   procedure Ask_Now (This : in out Object);
   -- Programs an Ask event for later
   procedure Ask_Later (This : in out Object; After : in Duration := 0.0);
   ...
   procedure Count (This : in out Object; Signal : in Signals.Object);

   ------------------------------------------------------------------------
   -- Discount                                                           --
   ------------------------------------------------------------------------
   -- Discounts a hub which has been gone
   procedure Discount (This : in out Object);
   ...
   procedure Fail (This : in out Object);
   ...
   ------------------------------------------------------------------------
   -- Launchs a ping
   procedure Ping (This : in out Object);

   ------------------------------------------------------------------------
   -- Query                                                              --
   ------------------------------------------------------------------------
   -- Launchs a query
   procedure Query (This : in out Object);
   ...
   procedure Update (This : in out Object; Answer : in Signals.Object);
