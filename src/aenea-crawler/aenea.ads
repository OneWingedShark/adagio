...
package Aenea is
   ...
   Version    : constant String := "Aenea 3.2.9 20051208 Mnemosyne";
   Vendor     : constant String := "AENE";
   Version_id : constant String := Version(Version'First + 6 .. Version'Last);
